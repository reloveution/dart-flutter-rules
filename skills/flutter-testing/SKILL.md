...
3. **Need to mock dependencies?**
   - Yes → See [Mocking Guide](references/mocking.md); project uses Mocktail – see [Mocktail Guide](references/mocktail.md)
...
- [Mocktail Guide](references/mocktail.md) - Project Mocktail conventions (Fake vs Mock, fallback values, stubbing)
